...
class Booking(models.Model):
    ...
    Error_img=models.ImageField(upload_to='uploads/')
...
class Payment(models.Model):
    ...
    technicianid = models.ForeignKey('Technician', on_delete=models.CASCADE, null=True, blank=True)
    amount=models.CharField(max_length=100)
    curr_date=models.DateField(auto_now_add=True)
    delivery_count = models.IntegerField(default=0) 
    deliveryid = models.ForeignKey('Delivery', on_delete=models.CASCADE, null=True, blank=True)
...
class Order(models.Model):
    ...
    del_status=models.IntegerField()
    ret_status = models.IntegerField(default=0)
    shopid = models.ForeignKey('Shop', on_delete=models.CASCADE, null=True, blank=True)
